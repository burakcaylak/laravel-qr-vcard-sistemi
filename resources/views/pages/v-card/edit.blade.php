<x-default-layout>
    ...
    @section('title')
        {{ __('common.edit_v_card') }}
    @endsection

    @section('breadcrumbs')
        {{ Breadcrumbs::render('v-card.edit', $vCard) }}
    @endsection
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">
                ...
                <h3 class="fw-bold m-0 d-inline">{{ __('common.edit_v_card') }}</h3>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('v-card.update', $vCard) }}" method="POST" id="v_card_form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-5">
                    ...
                    <select name="template_id" class="form-select" data-control="select2" data-placeholder="{{ __('common.select_template') }}">
                        ...
                        @foreach($templates as $template)
                            <option value="{{ $template->id }}" {{ old('template_id', $vCard->template_id) == $template->id ? 'selected' : '' }}>{{ $template->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="mb-5">
                    ...
                    <select name="category_id" class="form-select" data-control="select2" data-placeholder="{{ __('common.select_category') }}">
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ old('category_id', $vCard->category_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-5">
                    ...
                    @if($vCard->image_path)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $vCard->image_path) }}" alt="vCard Image" class="img-thumbnail" style="max-width: 200px;">
                        </div>
                    @endif
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="name_tr" class="form-control" value="{{ old('name_tr', $vCard->name_tr) }}">
                    </div>
                    <div class="col-md-6 mb-5">
                        <label class="form-label">{{ __('common.title_tr') }}</label>
                        <input type="text" name="title_tr" class="form-control" value="{{ old('title_tr', $vCard->title_tr) }}">
                    </div>
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.email_tr') }}</label>
                    <input type="email" name="email_tr" class="form-control" value="{{ old('email_tr', $vCard->email_tr) }}">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.company_tr') }}</label>
                    <input type="text" name="company_tr" class="form-control" value="{{ old('company_tr', $vCard->company_tr) }}">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.address_tr') }}</label>
                    <textarea name="address_tr" class="form-control" rows="3">{{ old('address_tr', $vCard->address_tr) }}</textarea>
                </div>

                <div class="row">
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.company_phone_tr') }}</label>
                        <input type="text" name="company_phone_tr" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('company_phone_tr', $vCard->company_phone_tr) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.extension_tr') }}</label>
                        <input type="text" name="extension_tr" class="form-control" value="{{ old('extension_tr', $vCard->extension_tr) }}">
                    </div>
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.fax_tr') }}</label>
                        <input type="text" name="fax_tr" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('fax_tr', $vCard->fax_tr) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="mobile_phone_tr" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('mobile_phone_tr', $vCard->mobile_phone_tr) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                    <div class="col-md-6 mb-5">
                        <label class="form-label">{{ __('common.website_tr') }}</label>
                        <input type="url" name="website_tr" class="form-control" value="{{ old('website_tr', $vCard->website_tr) }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="name_en" class="form-control" value="{{ old('name_en', $vCard->name_en) }}">
                    </div>
                    <div class="col-md-6 mb-5">
                        <label class="form-label">{{ __('common.title_en') }}</label>
                        <input type="text" name="title_en" class="form-control" value="{{ old('title_en', $vCard->title_en) }}">
                    </div>
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.email_en') }}</label>
                    <input type="email" name="email_en" class="form-control" value="{{ old('email_en', $vCard->email_en) }}">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.company_en') }}</label>
                    <input type="text" name="company_en" class="form-control" value="{{ old('company_en', $vCard->company_en) }}">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.address_en') }}</label>
                    <textarea name="address_en" class="form-control" rows="3">{{ old('address_en', $vCard->address_en) }}</textarea>
                </div>

                <div class="row">
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.company_phone_en') }}</label>
                        <input type="text" name="company_phone_en" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('company_phone_en', $vCard->company_phone_en) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.extension_en') }}</label>
                        <input type="text" name="extension_en" class="form-control" value="{{ old('extension_en', $vCard->extension_en) }}">
                    </div>
                    <div class="col-md-4 mb-5">
                        <label class="form-label">{{ __('common.fax_en') }}</label>
                        <input type="text" name="fax_en" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('fax_en', $vCard->fax_en) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="mobile_phone_en" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('mobile_phone_en', $vCard->mobile_phone_en) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                    <div class="col-md-6 mb-5">
                        <label class="form-label">{{ __('common.website_en') }}</label>
                        <input type="url" name="website_en" class="form-control" value="{{ old('website_en', $vCard->website_en) }}">
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="email" name="email" class="form-control" value="{{ old('email', $vCard->email) }}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-5">
                        ...
                        <input type="text" name="mobile_phone" class="form-control phone-input" placeholder="{{ __('common.phone_placeholder') }}" value="{{ old('mobile_phone', $vCard->mobile_phone) }}">
                        <small class="form-text text-muted">{{ __('common.phone_format_hint') }}</small>
                    </div>
                    <div class="col-md-6 mb-5">
                        <label class="form-label">{{ __('common.website') }}</label>
                        <input type="url" name="website" class="form-control" value="{{ old('website', $vCard->website) }}">
                        <small class="form-text text-muted">{{ __('common.common_fields_hint') }}</small>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    <label class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" name="is_active" value="1" {{ old('is_active', $vCard->is_active) ? 'checked' : '' }}>
                        <span class="form-check-label">{{ __('common.active') }}</span>
                    </label>
                </div>

                <div class="d-flex justify-content-end">
                    <a href="{{ route('v-card.show', $vCard) }}" class="btn btn-light me-3">{{ __('common.cancel') }}</a>

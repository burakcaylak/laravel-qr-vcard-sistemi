<x-default-layout>
    ...
    @section('breadcrumbs')
        {{ Breadcrumbs::render('v-card-template.create') }}
    @endsection

    <div class="card">
        <div class="card-header">
            <div class="card-title">
                <h3 class="fw-bold m-0">{{ __('common.create_vcard_template') }}</h3>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('v-card-template.store') }}" method="POST" id="template_form" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <input type="color" name="color" class="form-control form-control-color" value="{{ old('color', '#0033A1') }}">
                ...
                <div class="mb-5">
                    ...
                    <input type="url" name="facebook_url" class="form-control" value="{{ old('facebook_url') }}" placeholder="https://facebook.com/...">
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="url" name="x_url" class="form-control" value="{{ old('x_url') }}" placeholder="https://x.com/...">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.linkedin_url') }}</label>
                    <input type="url" name="linkedin_url" class="form-control" value="{{ old('linkedin_url') }}" placeholder="https://linkedin.com/...">
                </div>

                <div class="mb-5">
                    <label class="form-label">{{ __('common.youtube_url') }}</label>
                    <input type="url" name="youtube_url" class="form-control" value="{{ old('youtube_url') }}" placeholder="https://youtube.com/...">
                </div>
            ...
            document.getElementById('logo_file')?.addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = function(event) {
                        ...
                        preview.innerHTML = `<img src="${event.target.result}" alt="Logo" class="img-thumbnail" style="max-height: 100px;">`;
                    };
                    reader.readAsDataURL(e.target.files[0]);
                }
            });

            document.getElementById('background_file')?.addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    const reader = new FileReader();
                    reader.onload = function(event) {
                        const preview = document.getElementById('background_preview');
                        preview.innerHTML = `<img src="${event.target.result}" alt="Background" class="img-thumbnail" style="max-height: 200px;">`;
                    };
                    reader.readAsDataURL(e.target.files[0]);
                }
            });

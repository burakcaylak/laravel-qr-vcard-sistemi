    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <!--begin::Toolbar-->
                <div class="d-flex justify-content-end gap-2" data-kt-qr-table-toolbar="base">
                    <!--begin::Bulk Actions-->
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                setTimeout(function() {
                    ...
                    const checkedBoxes = document.querySelectorAll('input[type="checkbox"][data-qr-code-id]:checked');
                    const ids = Array.from(checkedBoxes).map(cb => cb.getAttribute('data-qr-code-id'));
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            fetch('{{ route('qr-code.bulk-action') }}', {
                                method: 'POST',
                                headers: {
